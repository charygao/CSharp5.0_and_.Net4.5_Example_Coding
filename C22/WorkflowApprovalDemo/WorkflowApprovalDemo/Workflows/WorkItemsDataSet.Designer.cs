            ...
            public bool Approved {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("表“WorkItems”中列“Approved”的值为 DBNull。", e);
                    }
                }
                set {
            ...
            public string Result {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("表“WorkItems”中列“Result”的值为 DBNull。", e);
                    }
                }
                set {
...
namespace Workflows.WorkItemsDataSetTableAdapters {
    ...
    public partial class WorkItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"
                      INSERT INTO [dbo].[WorkItems] ([WorkItemName], [WorkItemType], [Description], [Reason], [DateRequested], [FundingCostCenter], [AreaAffected], [Approved], [Result]) VALUES (@WorkItemName, @WorkItemType, @Description, @Reason, @DateRequested, @FundingCostCenter, @AreaAffected, @Approved, @Result);
    ...
    public partial class WorkTypesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "\r\n                      INSERT INTO [dbo].[WorkTypes] ([WorkTypeName]) VALUES (@W" +
                "orkTypeName);\r\n                      SELECT WorkTypeName FROM WorkTypes WHERE (W" +
                "orkTypeName = @WorkTypeName)\r\n                    ";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "\r\n                      UPDATE [dbo].[WorkTypes] SET [WorkTypeName] = @WorkTypeNa" +
                "me WHERE (([WorkTypeName] = @Original_WorkTypeName));\r\n                      SEL" +
                "ECT WorkTypeName FROM WorkTypes WHERE (WorkTypeName = @WorkTypeName)\r\n          " +
                "          ";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
    ...
    public partial class UserActivitiesWorkItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"
                      INSERT INTO [dbo].[UserActivitiesWorkItems] ([ActivityGuid], [WorkItemName]) VALUES (@ActivityGuid, @WorkItemName);
            ...
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"
                      UPDATE [dbo].[UserActivitiesWorkItems] SET [ActivityGuid] = @ActivityGuid, [WorkItemName] = @WorkItemName WHERE (([ActivityGuid] = @Original_ActivityGuid) AND ([WorkItemName] = @Original_WorkItemName));
                      SELECT ActivityGuid, WorkItemName FROM UserActivitiesWorkItems WHERE (ActivityGuid = @ActivityGuid) AND (WorkItemName = @WorkItemName)
                    ";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
